...
c2.sol also contains a function which will provide you the campaign details if you enter the campaign ID.
c2.sol contains a payable function where funders can fund amount to a campaign only once.
